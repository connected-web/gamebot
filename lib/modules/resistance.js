...
function pick(api, data) {
  ...
  api.respond('resistance', `${playerName} has picked ${grammarList(names)} to go on the next mission.`);
  recordHistory('picks received ' + names, data);
}
