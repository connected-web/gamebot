...
function coverLocation (api, data, word, model) {
  ...
  if (location.revealed) {
    ...
    api.respond(model.gameChannel, `${word} has been covered as a :${location.team}: ${location.team} location, the :${teamName.toLowerCase()}: ${teamName} Team have ended their turn!`)
