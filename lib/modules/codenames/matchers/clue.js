...
function clue (api, data, model) {
  ...
  api.respond(model.gameChannel, `Clue has been given to the ${team.name} Team: *${clue.word} ${clue.number}* - ${playerIds} identify ${clue.number} word(s) by replying with *pick word*`)
}
