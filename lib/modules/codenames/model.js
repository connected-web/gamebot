...
function reset (model) {
  ...
  model.started = false
  model.turnCounter = 0
  model.activeSpymaster = false
}

function updateActiveSpymaster (model) {
  model.activeSpymaster = (model.teams[model.turnCounter % model.teams.length]).spymaster
}
...
function create () {
  ...
  model.updateActiveSpymaster = () => updateActiveSpymaster(model)
  return model
}
