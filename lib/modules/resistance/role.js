...
const roles = {
  ...
  Defector: {
    ...
    team: team.Resistance,
    description: 'May only play :success: or :fail:. Knows nothing, hidden from the Commander. Your allegiance might switch once, twice, or not at all during the game. Attempt to win the game based on allegiance.',
    isDefector: true
  },
  SpyDefector: {
    name: 'Spy Defector',
    team: team.Spies,
    description: 'May only play :success: or :fail:. Known to the spies. Your allegiance might switch once, twice, or not at all during the game. Attempt to win the game based on your allegiance.',
    knownToCommander: true,
    knownToSpies: true,
    knowsSpies: false,
    isDefector: true
